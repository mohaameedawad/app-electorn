...
// async loadData() {
//   try {
//     this.payments = await this.dbService.getPaymentsReceived();
...
//     accept: async () => {
//       try {
//         await this.dbService.deletePaymentReceived(payment.id!);
//         await this.loadData();
//       } catch (error) {
...
//   try {
//     if (this.isEditMode) {
//       await this.dbService.updatePaymentReceived(this.payment.id!, this.payment);
//     } else {
//       await this.dbService.addPaymentReceived(this.payment);
//     }
