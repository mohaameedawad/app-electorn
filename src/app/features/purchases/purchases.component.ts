...
//   async loadPurchases() {
//     this.data = await this.dbService.getPurchaseItems();
//   }
...
//   async loadSuppliers() {
//     const suppliersList = await this.dbService.getAllSuppliers();
...
//         // update existing
//         await this.dbService.updatePurchaseItem(
//           this.editingPurchaseId,
//           purchaseData
//         );
//       } else {
//         await this.dbService.addPurchaseItem(purchaseData);
//       }
//       await this.loadPurchases();
